<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="Booking.Account.Register" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="TitleContent" style="text-align: center">
        <a runat="server" href="~/">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/SignUp.png" alt="logo" BorderStyle="None" />
        </a>
        <br />
        <br />
        <br />
            ...
            <tr>
                ...
                <td>
                    <asp:CreateUserWizard ID="CreateUserWizard" runat="server" CreateUserButtonText="SIGN UP">
                        <CreateUserButtonStyle BackColor="#6fa8dc" BorderColor="#6fa8dc" BorderStyle="Solid"    Font-Names="sans-serif" Font-Size="13px" />
                        <WizardSteps>
                            ...
                            <asp:CompleteWizardStep runat="server">
                                ...
                                <tr>
                                    <td style="height: 20px"><strong>Please confirm and authorize your registration by pressing the <span style="color: #6fa8dc">Confirm</span> button.</strong></td>
                                </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    ...
                                                    <asp:Button ID="ContinueButton" runat="server" CausesValidation="False" CommandName="Continue" OnCommand="ContinueButton_Command" Style="background-color: #6fa8dc" Text="CONFIRM" ValidationGroup="CreateUserWizard" BorderColor="#6fa8dc" BorderStyle="Solid"    Font-Names="sans-serif" Font-Size="13px" />
