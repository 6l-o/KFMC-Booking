<%@ Page Title="Show Roles & Responsibilities" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    ...
    Inherits="Booking.Admin.showRoles" %>
           ...
           <tr>
               ...
               <td style="width: 177px">
                   <asp:Button ID="btnLinkUserRole" runat="server" OnClick="btnLinkUserRole_Click" Text="Link User Role"
                       Width="124px" style="margin-left: 0px; background-color: #6fa8dc;" TabIndex="6"  />
               </td>
               </tr>
               <tr>
                   <td>
                   ...
                   <td style="width: 177px">
                       <asp:Button ID="btnUnLinkUserToRole" runat="server" OnClick="btnUnLinkUserToRole_Click"
                           Text="UnlinkUsertoRole" Width="124px" style="background-color: #6fa8dc;" />
                   </td>
               </tr>
               <tr>
                   ...
                   <td >
                       <asp:Button ID="btnShowAllUser" runat="server" OnClick="btnShowAllUser_Click" Text="Show All Users"
                           Width="124px" style="background-color: #6fa8dc;" />
                   </td>
               </tr>
               <tr>
                   <td class="style3" style="width: 68px">
                   ...
                   <td align="center" class="style4">
                       <asp:Button ID="btnCreateUser0" runat="server" OnClick="btnCreateUser_Click" Style="margin-left: 0px; background-color: #6fa8dc;"
                   ...
                   <td align="center" >
                       <asp:Button ID="btnCreateRole0" runat="server" OnClick="btnCreateRole_Click" 
                           Text="Create Role" Width="98px" TabIndex="5" style="background-color: #6fa8dc;" />
                       </td>
                   <td >
                       <asp:Button ID="btnShowAllRoles" runat="server" OnClick="btnShowAllRoles_Click" 
                           Text="Show All Roles" Width="124px" style="background-color: #6fa8dc;"
                           />
                   </td>
               </tr>
               <tr>
                   ...
                   <td align="center" class="style4">
                       <asp:Button ID="btnDeleteUser0" runat="server" OnClick="btnDeleteUser_Click" Text="Delete User" Width="105px" style="background-color: #6fa8dc;" />
                   </td>
                   <td align="center" class="style4" style="width: 42px">
                       </td>
                   <td align="center">
                       
                       <asp:Button ID="btnDeleteRole1" runat="server" OnClick="btnDeleteRole_Click" Text="Delete Role" style="background-color: #6fa8dc;" />
                   </td>
                   <td style="width: 177px">
                       <asp:Button ID="btnUpdateUser" runat="server" OnClick="btnUpdateUser_Click" Text="Update User" Width="125px" style="background-color: #6fa8dc;" />
                   </td>
           </tr>
       </table>
        <br />
       <table border="1">
            ...
            <tr>
                <td valign="top">
                 ...
                 <td valign="top">
                   <asp:Button ID="btnUserRoleAssign" runat="server"  Text="Link User Role" OnClick="btnUserRoleAssign_Click" Width="120px" style="background-color: #6fa8dc;" /><br />
                   <asp:Button ID="btnUnlinkUserRoles" runat="server" OnClick="btnUnlinkUserRoles_Click" Text="Unlink User Role" Width="120px" style="background-color: #6fa8dc;" /><br />
                  <asp:Button ID="btnDeleteRoles" runat="server" OnClick="btnDeleteRoles_Click" Text="Delete Roles" Width="120px" style="background-color: #6fa8dc;" /><br />
                  <asp:Button ID="btnDeleteUsers" runat="server" OnClick="btnDeleteUsers_Click" Text="Delete Users" Width="120px" style="background-color: #6fa8dc;" />  
                </td>
            </tr>
            <tr>
                <td colspan="2">
...
<%--        <fieldset>
 ...
 --%>
    ...
    <fieldset   style="width: auto; ">
        ...
        <table  style= "border:10px solid #6fa8dc">
