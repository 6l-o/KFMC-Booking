<%@ Page Title="Password Recovery" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="passwordRecovery.aspx.cs" Inherits="Booking.Admin.passwordRecovery" %>
             ...
             <MailDefinition From="aalhussein63@gmail.com" Subject="Forgetton Password" Priority="High" >
                ...
                <UserNameTemplate>
                    ...
                    UserName:
                        ...
                        Text="SEND" CommandName="Submit" Style="background-color: #6fa8dc" BorderColor="#6fa8dc" BorderStyle="Solid" Font-Bold="True" Font-Names="sans-serif" Font-Size="13px" /><br />
